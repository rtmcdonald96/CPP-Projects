...
Implemented new functionality for Inventory/Customerinfo/Purchases
Decoupled and removed previous functionality related to library scenarios
Current iteration has varied views for scenario based and actual use due to constructor limitation.
Could adjust constructors to be 2 tiered or only allow each login to be of a singular role.